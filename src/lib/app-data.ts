...
export const studentNavItems: NavItem[] = [
  ...
  { title: "Quick Quiz", to: "/quick-quiz", icon: Sparkles, keywords: ["quick", "auto", "random"] },
...
export const adminNavItems: NavItem[] = [
  ...
  { title: "Quiz Review", to: "/admin/quiz-review", icon: ShieldCheck, keywords: ["review", "quick quiz", "approve"] },
